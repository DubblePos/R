# 날짜 : 2021/11/15
# 이름 : 박승필
# 내용 : ch10.분석절차와 가설검정 교재 p353

#############################################
#스포츠 음료 용량이 제품에 표시된 300ml보다 모자를 것 같아서
#직접 조사를 해보고자 한다. 표본 300개를 대상으로 용량을 측정한 결과,
#평균이 244.65로 확인 되었다. 표준편차가 20일 때, 가설을 수립하고
#유의수준 0.05에서 좌측검정을 실시하시오.

#1)귀무가설 설정
#귀무가설 :M = 300 스포츠음료 용량은 300ml 이다.
#대립가설 :M < 300 스포츠음료 용량은 300ml 보다 작다이다.
...
#########################################################################
# 어느 제품의 평균 무게는 30kg, 표준편차 5로 파악되었다.
